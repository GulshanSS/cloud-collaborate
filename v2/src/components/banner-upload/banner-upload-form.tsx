  ...
  > = async (values) => {
    ...
    try {
      ...
      if (dirType === "file") {
        ...
        await updateFile(id, { bannerUrl: filePath });
      }
      ...
      if (dirType === "folder") {
        ...
        await updateFolder(id, { bannerUrl: filePath });
      }
      ...
      if (dirType === "workspace") {
        ...
        await updateWorkspace(id, { bannerUrl: filePath });
      }
    } catch (error) {
      console.log(error);
      toast({
        variant: "destructive",
        title: "Error",
        description: "Could not upload the banner",
      });
    }
  };
