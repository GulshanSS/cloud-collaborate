    ...
    Tables: {
      ...
      prices: {
        Row: {
          ...
          id: string;
          interval:
            | Database["cloud-collaborate-v2"]["Enums"]["pricing_plan_interval"]
            | null;
          ...
          type:
            | Database["cloud-collaborate-v2"]["Enums"]["pricing_type"]
            | null;
      ...
      subscriptions: {
        Row: {
          ...
          status:
            | Database["cloud-collaborate-v2"]["Enums"]["subscription_status"]
            | null;
